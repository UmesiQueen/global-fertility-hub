...
function WhatWeOffer() {
  return (
    <section aria-labelledby="what-we-offer">
      ...
      <div className="grid overflow-hidden rounded-3xl bg-card md:shadow-[0_8px_40px_-12px] shadow-primary/5 ring-1 ring-border/60 sm:grid-cols-2 lg:grid-cols-4">
...
function BottomWave() {
  return (
    <svg
      ...
      aria-hidden="true"
      className="absolute inset-x-0 bottom-0 z-10 h-0 w-full lg:h-24"
    >
      <defs>
